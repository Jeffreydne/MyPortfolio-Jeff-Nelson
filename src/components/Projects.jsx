...
function Projects() {
    return (
        <section id="projects">
            <h2>My Projects</h2>
            {/* card-container div holds all 3 projects. The small-card-containers below (<ProjectRecipeMama /> and (<ProjectMovieMachine />) will hold 2 non-featured projects each & flex them horizontally at large screen sizes, changing to vertical at mobile size */}
            <div className="card-container">
                {/* class card divs allow the card elements (card-header, <a>tag with image & card-footer with description) to align vertically using flexbox. */}
                <div className="card">
